...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL','sqlite:///data.db').replace('postgres://', 'postgresql://')  # trying to fetch environment varibale "DATABASE_URL", set to sqlite if not found
