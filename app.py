...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL'.replace('postgres://', 'postgresql://'),'sqlite:///data.db')  # trying to fetch environment varibale "DATABASE_URL", set to sqlite if not found
